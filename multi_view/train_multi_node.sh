...
PROJECT_NAME=Wan2.1_14B-T2V-Multi_view-normal_rope_wangpan_480_832pix_RoPE_split5_210_switchstep1000_mae0p6
...
sed -i "s/^machine_rank: .*/machine_rank: ${MACHINE_RANK}/" "/root/paddlejob/workspace/qizipeng/baidu/personal-code/Multi-view/multi_view/conf/accelerate_config_14B_L_multi-node.yaml"
sed -i "s/^main_process_ip: .*/main_process_ip: ${MASTER_ADDR}/" "/root/paddlejob/workspace/qizipeng/baidu/personal-code/Multi-view/multi_view/conf/accelerate_config_14B_L_multi-node.yaml" 
sed -i "s/^main_process_port: .*/main_process_port: ${MASTER_PORT}/" "/root/paddlejob/workspace/qizipeng/baidu/personal-code/Multi-view/multi_view/conf/accelerate_config_14B_L_multi-node.yaml" 

set +e
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
# Attention mask is enabled; keep FlashAttention off to avoid incompatibilities.
export USE_FLASH_ATTN=0
MACHINE_RANK=$MACHINE_RANK  accelerate launch --config_file="/root/paddlejob/workspace/qizipeng/baidu/personal-code/Multi-view/multi_view/conf/accelerate_config_14B_L_multi-node.yaml" \
